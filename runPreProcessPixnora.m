...
clear all;close all;
%sites
cellRec{1}{1} = 'Z:\Jamann\PROJECTS - data\Neuropixels NIN202103\Rawdata\SpikeGLX\20201002_NPX3_RunOptoNoraR01_g0';
...
addpath(genpath('C:\Users\jamann\Documents\GitHub\Kilosort')); % path to kilosort folder
addpath('C:\Users\jamann\Documents\GitHub\npy-matlab'); % for converting to Phy
